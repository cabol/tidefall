defmodule Tidefall do
  ...
  Concrete buffer types:
    ...
    * `Tidefall.CoalescedMap` — Coalescing key-value buffer (`:set` ETS;
  ...
  > Mirrored in `usage-rules/tidefall.md` (Telemetry section). The
  > list below is the canonical contract; keep the mirror in sync
  > when adding events.
