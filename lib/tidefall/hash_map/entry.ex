defmodule Tidefall.HashMap.Entry do
  @moduledoc """
  ...
  ## Fields
    ...
    * `:version` — The version stamp. Set explicitly via
      `Tidefall.HashMap.put_newer/4` /
      `Tidefall.HashMap.put_all_newer/3`; `0` for entries
      written via plain `Tidefall.HashMap.put/4` /
      `Tidefall.HashMap.put_all/3`.
    * `:updates` — How many times this entry was conditionally
      replaced by a newer version. `0` for new inserts and for
      entries written via plain `Tidefall.HashMap.put/4` /
      `Tidefall.HashMap.put_all/3`.
