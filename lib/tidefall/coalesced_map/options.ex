defmodule Tidefall.CoalescedMap.Options do
  @moduledoc false

  alias Tidefall.Buffer

  # CoalescedMap-specific runtime options, layered on top of the shared
  ...
  # Runtime schema: shared opts + CoalescedMap opts.
  @runtime_opts_schema NimbleOptions.new!(Buffer.Options.runtime_opts() ++ cm_runtime_opts)
