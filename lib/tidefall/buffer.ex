defmodule Tidefall.Buffer do
  ...
  (`Tidefall.Queue`, `Tidefall.CoalescedMap`), which delegates the shared
  operations here.
  ...
  > `Tidefall.CoalescedMap.start_link/1` instead, as they automatically
  ...
  ## Shared routing helpers (used by Queue, CoalescedMap, etc.)
